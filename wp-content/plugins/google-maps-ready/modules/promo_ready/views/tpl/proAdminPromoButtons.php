...
<div id="gmpMarkersListTypeTplsShell" style="display: none;">
	...
	?>
	<li class="gmpTemplatePrevShell gmpTemplatePrevShell-existing gmpTemplatePrevShell-<?php echo $id?>" data_code="<?php echo $id?>" data-url="<?php echo $dView['url']?>" <?php if(!empty($liStyle)) { echo $liStyle; }?>>
		<h2 style="text-align: center; color: #454545; <?php if($isSlider) {?> padding-left: 138px;<?php }?>"><?php echo $dView['label']?>
			<?php if($isSlider) { ?>
				<input type="submit" class="button button-primary button-large" value="<?php langGmp::_e('Available in PRO')?>" style="margin-left: 0; margin-right: 0; display: inline;" data_code="<?php echo $id?>" data-url="<?php echo $dView['url']?>" />
			<?php }?>
		</h2><hr />
		<?php echo htmlGmp::img( $dView['prev_img'], false, array('attrs' => 'class="gmpAdminTemplateImgPrev"'));?><hr />
		<?php if(!$isSlider) { ?>
			<input type="submit" class="button button-primary button-large" value="<?php langGmp::_e('Available in PRO')?>"  data_code="<?php echo $id?>" data-url="<?php echo $dView['url']?>" />
		<?php }?>
	</li>
	<?php } ?>
	</ul>
...
<div id="gmpCustomMapControlsTplsShell" style="display: none;">
	...
	<li class="gmpTemplatePrevShell gmpTemplatePrevShell-existing gmpTemplatePrevShell-<?php echo $cmc['code']?>" data_code="<?php echo $cmc['code']?>" data-url="<?php echo $cmc['url']?>">
		...
		<input type="submit" class="button button-primary button-large" value="<?php langGmp::_e('Available in PRO')?>"  data_code="<?php echo $cmc['code']?>" data-url="<?php echo $cmc['url']?>" />
	</li>
	<?php } ?>
	</ul>
</div>
...
<div id="gmpGSControlsTplsShell" style="display: none;">
	...
	<li class="gmpTemplatePrevShell gmpTemplatePrevShell-existing gmpTemplatePrevShell-<?php echo $s['code']?>" data_code="<?php echo $s['code']?>" data-url="<?php echo $dView['url']?>">
		...
		<input type="submit" class="button button-primary button-large" value="<?php langGmp::_e('Available in PRO')?>"  data_code="<?php echo $s['code']?>" data-url="<?php echo $dView['url']?>" />
	</li>
	<?php } ?>
	</ul>
</div>

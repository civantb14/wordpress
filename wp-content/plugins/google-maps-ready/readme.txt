...
= 1.3.1 =
 * Added Thai language
 * PRO - review and small issues fix for DEBUG mode
 * PRO - iframe embed view type - load iframe via https
 * PRO - added new style - "Lunar Landscape"
 * Fix issue when some other plugin/theme add new elements to all objects
 * PRO - user markers - possibility to select icon from frontend
 * Small DEBUG issues fix

= 1.2.7 =
 * Possibility to post markers by users from frontend - PRO - https://readyshoppingcart.com/product/google-maps-plugin/
 * Button to show current user location - on your map - PRO - https://readyshoppingcart.com/product/google-maps-plugin/
 * PRO - Get Directions work without markers list
 * PRO - Custom mp controls - search work with miles
 * Update translation file (French language)
 * Minor issues fix
...
= 1.2.5.4 =
 * Fix for bicycling layer
 * Load directions PRO scripts each time when map is displayed - as it have some core functions
 * Custom map controls - do not init if it was already initialized - https://readyshoppingcart.com/product/google-maps-plugin/
 * Iframe embed mode - move footer scripts variables add action from 999 position to default - https://readyshoppingcart.com/product/google-maps-plugin/

= 1.2.5.3 =
 * Small Groups list fix for for admin area
 * Added possibility to set font size and color for markers infowindow title
 * Minor issues fix

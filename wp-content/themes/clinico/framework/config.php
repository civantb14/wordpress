...
if (!class_exists("Redux_Framework_config")) {
	...
	class Redux_Framework_config {
		...
		public function setSections() {
			...
			$this->sections[] = array(
				'title' => __('Configuración', THEME_SLUG),
			...
			$this->sections[] = array(
				'title' => __('Mostrar Opciones', THEME_SLUG),
				'icon_class' => 'icon-large',
			...
			$this->sections[] = array(
				'title' => __('Opciones de estilo', THEME_SLUG),
				'icon_class' => 'icon-large',
				'icon' => 'el-icon-brush',
				// 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
				'fields' => array(
			...
			$this->sections[] = array(
				'title' => __('Opciones de Diseño', THEME_SLUG),
				'icon_class' => 'icon-large',
				'icon' => 'el-icon-magic',
				'customizer' => false,
				'fields' => array(
			...
			$this->sections[] = array(
				'title' => __('Tipografía', THEME_SLUG),
				'icon_class' => 'icon-large',
				'icon' => 'el-icon-font',
				// 'submenu' => false, // Setting submenu to false on a given section will hide it from the WordPress sidebar menu!
				'fields' => array(
			...
			$this->sections[] = array(
				'title' => __('Página de Inicio', THEME_SLUG),
				'icon_class' => 'icon-large',
				'icon' => 'el-icon-home',
				'customizer' => false,
				'fields' => array(
		...
		$this->sections[] = array(
			...
			'icon_class' => 'icon-large',
			'title' => __('Opciones Sociales', THEME_SLUG),
			'customizer' => false,
			'fields' => array(
				array(
					'id' => 'turn-twitter',
